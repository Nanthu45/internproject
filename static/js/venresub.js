...
function returnToVenReForm() {
    document.getElementById('venresubmissionForm').style.display = 'block';
    document.getElementById('venresubmissionMessage').style.display = 'none';
